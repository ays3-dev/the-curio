...
function getSourceIcon(source) {
    ...
    if (s.includes("openlibrary"))
        return `<img src="/media/openlibrary.png" width="18" style="border-radius: 50%;">`;
    ...
    if (s.includes("history"))
        return `<img src="/media/history.png" width="16">`;
    if (s.includes("animal"))
        return `<img src="https://cdn.simpleicons.org/paw/FF9900" width="16">`;
    if (s.includes("cia"))
        return `<img src="/media/cia.png"  width="18" style="border-radius: 50%;">`;
